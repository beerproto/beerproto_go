...
type FermentationStepType struct {
	...
	VesselPressure *PressureType `protobuf:"bytes,13,opt,name=vessel_pressure,json=vesselPressure,proto3" json:"vessel_pressure,omitempty"`
...
func (x *FermentationStepType) GetVesselPressure() *PressureType {
	if x != nil {
...
const file_beerproto_v1_fermentation_step_proto_rawDesc = "" +
	"\n" +
	"$beerproto/v1/fermentation_step.proto\x12\fbeerproto.v1\x1a$beerproto/v1/measureable_units.proto\x1a\x1bbuf/validate/validate.proto\"\x9c\x05\n" +
	...
	"\x06vessel\x18\f \x01(\tR\x06vessel\x12C\n" +
	"\x0fvessel_pressure\x18\r \x01(\v2\x1a.beerproto.v1.PressureTypeR\x0evesselPressureB\xb6\x01\n" +
...
var file_beerproto_v1_fermentation_step_proto_goTypes = []any{
	...
	(*PressureType)(nil),         // 5: beerproto.v1.PressureType
}
var file_beerproto_v1_fermentation_step_proto_depIdxs = []int32{
	...
	5, // 7: beerproto.v1.FermentationStepType.vessel_pressure:type_name -> beerproto.v1.PressureType
