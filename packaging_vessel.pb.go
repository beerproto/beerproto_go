...
type CarbonationStep int32

const (
	CarbonationStep_CARBONATION_STEP_UNSPECIFIED CarbonationStep = 0
	// forceCarbonation
	CarbonationStep_CARBONATION_STEP_FORCE_CARBONATION CarbonationStep = 1
	// priming
	CarbonationStep_CARBONATION_STEP_PRIMING CarbonationStep = 2
	// spunding
	CarbonationStep_CARBONATION_STEP_SPUNDING CarbonationStep = 3
	// naturalConditioning
	CarbonationStep_CARBONATION_STEP_NATURAL_CONDITIONING CarbonationStep = 4
)

// Enum value maps for CarbonationStep.
var (
	CarbonationStep_name = map[int32]string{
		0: "CARBONATION_STEP_UNSPECIFIED",
		1: "CARBONATION_STEP_FORCE_CARBONATION",
		2: "CARBONATION_STEP_PRIMING",
		3: "CARBONATION_STEP_SPUNDING",
		4: "CARBONATION_STEP_NATURAL_CONDITIONING",
	}
	CarbonationStep_value = map[string]int32{
		"CARBONATION_STEP_UNSPECIFIED":          0,
		"CARBONATION_STEP_FORCE_CARBONATION":    1,
		"CARBONATION_STEP_PRIMING":              2,
		"CARBONATION_STEP_SPUNDING":             3,
		"CARBONATION_STEP_NATURAL_CONDITIONING": 4,
	}
)

func (x CarbonationStep) Enum() *CarbonationStep {
	p := new(CarbonationStep)
	*p = x
	return p
}

func (x CarbonationStep) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (CarbonationStep) Descriptor() protoreflect.EnumDescriptor {
	return file_beerproto_v1_packaging_vessel_proto_enumTypes[1].Descriptor()
}

func (CarbonationStep) Type() protoreflect.EnumType {
	return &file_beerproto_v1_packaging_vessel_proto_enumTypes[1]
}

func (x CarbonationStep) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use CarbonationStep.Descriptor instead.
func (CarbonationStep) EnumDescriptor() ([]byte, []int) {
...
func (x *PackagingVesselType) GetCarbonationStep() CarbonationStep {
	if x != nil {
		return x.CarbonationStep
	}
	return CarbonationStep_CARBONATION_STEP_UNSPECIFIED
}
...
const file_beerproto_v1_packaging_vessel_proto_rawDesc = "" +
	...
	"\bgraphics\x18\x06 \x03(\v2\".beerproto.v1.PackagingGraphicTypeR\bgraphics\"\xe7\x05\n" +
	...
	"\x05notes\x18\f \x01(\tR\x05notes\x12H\n" +
	"\x10carbonation_step\x18\r \x01(\x0e2\x1d.beerproto.v1.CarbonationStepR\x0fcarbonationStep*\x9f\x02\n" +
	...
	"\x19PACKAGING_VESSEL_UNIT_CAN\x10\a*\xc3\x01\n" +
	"\x0fCarbonationStep\x12 \n" +
	"\x1cCARBONATION_STEP_UNSPECIFIED\x10\x00\x12&\n" +
	"\"CARBONATION_STEP_FORCE_CARBONATION\x10\x01\x12\x1c\n" +
	"\x18CARBONATION_STEP_PRIMING\x10\x02\x12\x1d\n" +
	"\x19CARBONATION_STEP_SPUNDING\x10\x03\x12)\n" +
	"%CARBONATION_STEP_NATURAL_CONDITIONING\x10\x04B\xb5\x01\n" +
...
var file_beerproto_v1_packaging_vessel_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_beerproto_v1_packaging_vessel_proto_goTypes = []any{
	(PackagingVesselUnit)(0),     // 0: beerproto.v1.PackagingVesselUnit
	(CarbonationStep)(0),         // 1: beerproto.v1.CarbonationStep
...
var file_beerproto_v1_packaging_vessel_proto_depIdxs = []int32{
	...
	6,  // 4: beerproto.v1.PackagingVesselType.step_time:type_name -> beerproto.v1.TimeType
	7,  // 5: beerproto.v1.PackagingVesselType.start_gravity:type_name -> beerproto.v1.GravityType
	7,  // 6: beerproto.v1.PackagingVesselType.end_gravity:type_name -> beerproto.v1.GravityType
	8,  // 7: beerproto.v1.PackagingVesselType.start_ph:type_name -> beerproto.v1.AcidityType
	8,  // 8: beerproto.v1.PackagingVesselType.end_ph:type_name -> beerproto.v1.AcidityType
	9,  // 9: beerproto.v1.PackagingVesselType.start_temperature:type_name -> beerproto.v1.TemperatureType
	9,  // 10: beerproto.v1.PackagingVesselType.end_temperature:type_name -> beerproto.v1.TemperatureType
	10, // 11: beerproto.v1.PackagingVesselType.target_carbonation:type_name -> beerproto.v1.CarbonationType
	1,  // 12: beerproto.v1.PackagingVesselType.carbonation_step:type_name -> beerproto.v1.CarbonationStep
